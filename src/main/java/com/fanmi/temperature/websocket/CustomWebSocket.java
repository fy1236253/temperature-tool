...
@Component
public class CustomWebSocket extends TextWebSocketHandler implements WebSocketHandler {

    public static Logger  log = LoggerFactory.getLogger(CustomWebSocket.class);
